 ...
 * @author Usuario
 */
public class InfoTable extends javax.swing.JDialog {

    /**
     * Creates new form InfoTable
     */
    public InfoTable(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InfoTable dialog = new InfoTable(new javax.swing.JFrame(), true);
